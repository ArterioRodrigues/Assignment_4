...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor() {
    ...
    this.addDebit = e => {
      ...
      this.setState({
        ...
        id: this.state.id + 1,
        accountBalance: this.state.accountBalance + parseFloat(e[1])
      });
    };
  ...
  async componentDidMount() {
    ...
    let accountBalance = parseFloat(creditSum - debitSum);
    this.setState({
      debits,
      credits,
      accountBalance,
...
//# sourceMappingURL=main.a5758ce26e8bc1f77925.hot-update.js.map